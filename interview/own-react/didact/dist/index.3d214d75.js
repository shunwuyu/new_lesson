...
function render(element1, container1) {
    const dom = element1.type == "TEXT_ELEMENT" ? document.createTextNode("") : document.createElement(element1.type);
    const isProperty = (key)=>key !== "children"
    ;
    Object.keys(element1.props).filter(isProperty).forEach((name)=>{
        dom[name] = element1.props[name];
    });
    element1.props.children.forEach((child)=>render(child, dom)
    );
...
/** @jsx Didact.createElement */ const element = /*#__PURE__*/ Didact.createElement("div", {
    ...
    __self: this
}, /*#__PURE__*/ Didact.createElement("h1", {
    __source: {
        fileName: "index.js",
        lineNumber: 46,
        columnNumber: 5
    ...
    __self: this
}, "Hello World"), /*#__PURE__*/ Didact.createElement("h2", {
...
},{}]},["kn9T2","iKiqL","bB7Pu"], "bB7Pu", "parcelRequire18ea")
